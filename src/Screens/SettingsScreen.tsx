...
const SettingsScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainContainer}>
        <View>
          <TouchableOpacity activeOpacity={0.8} style={styles.chipContainer} onPress={() => navigation.navigate("PreferencesScreen")}>
            <View style={styles.rowContainer}>
              <Ionicons name='ios-list-outline' size={wp(24)} color={COLORS.RED_COLOR} style={{ marginRight: wp(12) }} />
              <Text style={styles.chipText}>Preferences</Text>
            </View>
            <Ionicons name='md-arrow-forward-outline' size={wp(24)} color={COLORS.RED_COLOR} style={{ height: 32 }} />
          </TouchableOpacity>
          <View style={[styles.chipContainer, { marginTop: hp(12) }]}>
            <View style={styles.rowContainer}>
              <Ionicons name='notifications-outline' size={wp(24)} color={COLORS.RED_COLOR} style={{ marginRight: wp(12) }} />
              <Text style={styles.chipText}>Notifications</Text>
            </View>

            <Switch onStateChange={toggleNotification} />
          </View>
        </View>
        {false && (
          <TouchableOpacity
        ...
        <Text style={styles.versionText}>{`Version ${Application.expo.version}`}</Text>
      </View>
    </View>
  );
};
