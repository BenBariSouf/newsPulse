...
const IntroScreen = () => {
	...
	const data: FlatlistItem[] = [
		...
		},
		{
			...
			subtitle: "Easily share news with friends through social media, email, or messaging apps",
			img: require("../../assets/images/3.png"),
		},
		{
			title: "Get the Latest News at Your Fingertips",
			subtitle: "Personalize your news feed based on your interests and preferences",
	...
	return (
		<View style={{ flex: 1 }}>
			<StatusBar barStyle={"light-content"} backgroundColor={COLORS.RED_COLOR} />
			<FlatList
				ref={flatlistRef}
				bounces={true}
				data={data}
