...
const UserIntroStack = () => {
	return (
		<IntroStack.Navigator>
			...
			<IntroStack.Screen name="PersonaliseScreen" component={PersonaliseScreen} options={{ headerShown: false }} />
		</IntroStack.Navigator>
	);
};
...
const UserBookmarkStack = () => {
	return (
		<BookmarkStack.Navigator>
			<BookmarkStack.Screen name="BookmarkScreen" component={BookmarkScreen} options={{ headerShown: false }} />
		</BookmarkStack.Navigator>
	);
};
...
const UserTabStack = () => {
	return (
		<TabStack.Navigator id="tabs" tabBar={(props) => <BottomTabBar {...props} />} screenOptions={{ headerShown: false, tabBarHideOnKeyboard: false }}>
			<TabStack.Screen
				name="HomeTab"
...
const UserMainStack = () => {
	return (
		<AppStack.Navigator>
			<AppStack.Screen name="Home" component={UserTabStack} options={{ headerShown: false }} />
			<AppStack.Screen name="NewsScreen" component={NewsScreen} options={{ headerShown: false }} />
			<AppStack.Screen name="PreferencesScreen" component={PreferencesScreen} options={{ headerShown: false }} />
		</AppStack.Navigator>
	);
};
...
const App = () => {
	...
	return <NavigationContainer>{isUserOnbaord ? <UserMainStack /> : <UserIntroStack />}</NavigationContainer>;
};
